...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher, Mark Hays,
         Aaron Wilkin, their colleagues, and Triston Hine.
...
#        whose height is 100:  window = rg.RoseWindow(400, 100)
...
#             objects have:
#                x starting value, y starting value, radius
#
...
#        necessary?  Why?
#            When you want to analyze the creation to make sure it is in line with what you coded it to do.
#
